...
```shell
git clone https://github.com/Shubham260998/code
```

2. Open the project in an IDE of your choice.
3. Run the main application - `https://github.com/Shubham260998/code`.
    1. Create/Update the Run Configuration for the class to provide the program argument.<br />
       ![Edit Run Config window on Spring Tool Suite](https://github.com/Shubham260998/code)

       A sample log file is available in `resources/samples/logfile.txt`
    2. You can generate a sample log file using the
       utility `https://github.com/Shubham260998/code.loganalyser.utilities.LogFileGenerator`. You can specify the number of events to
